...
- Sử dụng Amazon Cognito để xác thực đăng ký và đăng nhập người dùng, bảo vệ an toàn cho cổng API Gateway.
...
5. **Xóa Cognito User Pool**:
   - Truy cập bảng quản trị Amazon Cognito.
   - Chọn User Pool bạn đã tạo, nhấn **Delete** và xác nhận xóa.
