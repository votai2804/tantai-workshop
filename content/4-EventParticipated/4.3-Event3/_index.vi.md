...
#### Kiến Thức Chuyên Môn (AWS)

- Thông qua các lời giải thích chi tiết từ anh chị FCAJ sau mỗi câu hỏi khó, em đã vá được nhiều "lỗ hổng" kiến thức về cách phối hợp các dịch vụ AWS, đặc biệt là các case-study thực tế đòi hỏi sự so sánh tối ưu chi phí và hiệu năng.
- Nắm bắt thêm các mẹo (tips & tricks) để xử lý các câu hỏi tình huống phức tạp trong các kỳ thi chứng chỉ AWS.

#### Tư Duy Chiến Thuật & Kỹ Năng Mềm

- **Quản trị rủi ro**: Bài học từ việc sử dụng "ngôi sao may mắn" cho thấy ranh giới mong manh giữa thành công và thất bại. Việc quyết định khi nào nên "tất tay" (như KLKAT, YoungflameIt) và khi nào nên chơi an toàn, chắc chắn (như Ngũ đại hiệp) là một kỹ năng ra quyết định cực kỳ quan trọng trong môi trường làm việc thực tế.
- **Tinh thần thép**: Giữ được sự bình tĩnh khi bị đối thủ dẫn trước hoặc khi đối mặt với câu hỏi quyết định định đoạt sự thắng thua của cả đội.

#### Ứng Dụng Vào Công Việc

- **Củng cố dự án hiện tại**: Những kiến thức AWS được ôn tập qua cuộc thi (nhất là các dịch vụ Compute và Database) giúp em tự tin hơn rất nhiều khi cấu hình và tối ưu hóa chi phí cho dự án "AI Riddle Generator" đang thực hiện.
- **Tư duy cẩn trọng**: Giống như việc cân nhắc dùng "ngôi sao may mắn", trước khi thay đổi một cấu trúc quan trọng trong dự án hoặc xóa một resource trên AWS, em học được cách phải đánh giá kỹ lưỡng tỷ lệ rủi ro (impact) thay vì thao tác theo cảm tính.
